...
def main():
    ...
    if yagpt_folder_id is None: value_01 = 'None'
    else: value_01 = yagpt_folder_id
    yagpt_folder_id = st.sidebar.text_input("YAGPT_FOLDER_ID", type='password', value=value_01)
