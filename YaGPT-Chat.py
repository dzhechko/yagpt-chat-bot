...
def main():
    ...
    if not yagpt_folder_id: yagpt_folder_id = st.sidebar.text_input("YAGPT_FOLDER_ID")
    else: yagpt_folder_id = st.sidebar.text_input("YAGPT_FOLDER_ID", value=yagpt_folder_id)
    ...
    if st.session_state['ready']:
        ...
        llm = YandexLLM(api_key=yagpt_api_key, folder_id=yagpt_folder_id, temperature = yagpt_temperature, max_tokens=7000)        
